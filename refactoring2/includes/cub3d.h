...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/09/09 04:32:25 by sungslee          #+#    #+#             */
/*   Updated: 2020/09/09 04:32:27 by sungslee         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				move_player(t_info *info, t_player *player,
								double move_speed);
...
int					load_image(t_info *info, int *texture, char *path,
					t_img *img);
...
void				get_sprite_color(t_info *info, t_sprite_ray *s_ray,
					int stripe);
